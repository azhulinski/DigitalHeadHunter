...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <h5 class="navbar-brand">${userName}</h5>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-center">
            <form action="/user/updateUserDetails"
                  method="post" class="form-horizontal"
                  modelAttribute="addUserInfo">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="dob" type="date" path="dateOfBirth" name="dateOfBirth"
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="avatar">select picture for avatar</label>
                    <div class="col-md-4">
                        <label class="radio-inline" for="avatar">
                            <input id="avatar" type="file" name="avatar" value="select file">
                        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <label class="radio-inline" for="married">
                            <input id="married" type="hidden" value='0' name="married">
